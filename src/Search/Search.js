    ...
    return(
      ...
      <div className="col-md-11 supplier-filter">
       ...
       <div className="col-md-2 ">
           <button className="btn btn-primary aply-filter" onClick={this.fetchProductByFilter.bind(this)} >Apply Filters</button>
           </div> 
          </div>
         </div>
      ...
      <div className="row">
          ...
          <div className="input-group ">
           ...
           <input className="form-control py-2 border-right-0 border" type="search" defaultValue=""  id="example-search-input"  onChange={this.handle.bind(this)} placeholder="Search with Keywords"  />
