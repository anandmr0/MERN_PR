      ...
      <section className="search">
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-6 supplier-buyer">
                <button
                  class="btn btn-primary supplier"
                  onClick={() =>
                    this.setState({ buyer: " / Search Supplier Products" })
                  }
                >
              ...
              <div className="col-md-6 supplier-buyer">
                <button
                  class="btn btn-primary buyer"
                  onClick={() =>
                    this.setState({ buyer: " / Search Buyer Requirements " })
                  }
                >
                  Search Buyer Product
                </button>
              </div>
            </div>
          </div>
              ...
              <div className="col-md-11 supplier-filter">
                ...
                <div className="row">
                  ...
                  <div className="col-md-2 ">
                    <button
                      className="btn btn-primary aply-filter"
                      onClick={this.fetchProductByFilter.bind(this)}
                    >
                      Apply Filters
                    </button>
                  </div>
          ...
          <div className="container">
            <div className="row">
                ...
                <div className="input-group search-filter">
                  ...
                  <span className="input-group-append">
                    <div
                      ...
                      onClick={this.fetchProduct.bind(this)}
                    >
              ...
              <div className="col-md-4 post-req-btn">
                <button class="btn btn-primary post-filter">
          ...
          <div className="container">
            <div class="row">
              ...
              <div className="col-md-1 selected-filter">
                <p>
                  {" "}
                  <a href="#" onClick={this.clearProductSelection.bind(this)}>
                    {this.state.clearAll}
                  </a>
                </p>
              </div>
        ...
        <section className="product-Details">
          <div className="container">
            <div class="row">
              {this.state.products &&
                this.state.products.data.product.map((product, index) => {
                  return (
                    <div className="col-md-4 product" key={index}>
                      ...
                      <div className="user-title">
                        <h1>
                          <strong>{product.buyer_name}</strong>
                        </h1>
                      ...
                      <div className="req-details">
                        <h1>
                          <strong>Fabric :</strong> {product.product_name}
                        </h1>
                        <h1>
                          <strong>Weight :</strong> {product.weight_gsm}
                        </h1>
                        <h1>
                          <strong>Quantity :</strong> {product.quantity}
                        </h1>
                        <h1 className="cost">
                          <strong>Cost Bracket :</strong> {product.price_rs}
                        </h1>
                        <h1>
                          <strong>Lead Time Provision :</strong>{" "}
                          {product.lead_time}
                        </h1>
                        <h1>
                          <strong>Delivery Location :</strong> Mumbai,
                          Maharashtra,India
                        </h1>
                      </div>
